...
export class default1694983170266 implements MigrationInterface {
    name = 'default1694983170266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Product" ("id" SERIAL NOT NULL, "category" text NOT NULL DEFAULT now(), "name" text NOT NULL, "content" text NOT NULL, "price" integer NOT NULL, "image" text NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_9fc040db7872192bbc26c515710" PRIMARY KEY ("id"))`);
